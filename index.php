			...
			<div id="navbar" class="navbar-collapse collapse">
				...
				<div id="system-status" class="panel panel-default" style="margin-bottom: 5px">
					<div class="panel-heading">
						<h3 class="panel-title">Información del Sistema<a href="?updated" target="_top" class="btn btn-success pull-right" style="margin:-6px -11px; color: white;"><i class="fa fa-refresh"></i></a></h3>
					</div>
						...
						<div class="row" style="margin: 0;">
							...
							<div class="col-xs-6 col-sm-3 text-center">
								<span class="chart" data-percent="<?php echo $disk_percentage; ?>">
									...
									<span class="label">Espacio local en disco</span>
								</span>
							</div>
							...
							<div class="col-xs-6 col-sm-3 text-center">
								<span class="chart" data-percent="<?php echo $memory_percentage; ?>">
									...
									<span class="label">Memoria Real</span>
								</span>
							</div>
							...
							<tbody>
								<tr>
									<td style="width:30%;vertical-align:middle; padding:8px;"><strong>Hostname</strong></td>
								...
								<tr>
									<td style="width:30%;vertical-align:middle; padding:8px;"><strong>Sistema Operativo</strong></td>
									<td style="width:70%; vertical-align:middle; padding:8px;"><span data-id="sysinfo_os"><?php echo $operating_system; ?></span></td>
								</tr>
								<tr>
									<td style="width:30%;vertical-align:middle; padding:8px;"><strong>Información del Procesador</strong></td>
									<td style="width:70%; vertical-align:middle; padding:8px;"><span data-id="sysinfo_kernel_arch"><?php echo $cpu_info; ?></span></td>
								</tr>

								<tr>
									<td style="width:30%;vertical-align:middle; padding:8px;"><strong>Tiempo encendido</strong></td>
									<td style="width:70%; vertical-align:middle; padding:8px;"><span data-id="sysinfo_uptime"><?php echo $uptime; ?></span></td>
								</tr>
								<tr>
									<td style="width:30%;vertical-align:middle; padding:8px;"><strong>Fecha actual del sistema</strong></td>
									<td style="width:70%; vertical-align:middle; padding:8px;"><span data-id="sysinfo_disk_space"><?php echo $date; ?></span></td>
								</tr>
								<tr>
									<td style="width:30%;vertical-align:middle; padding:8px;"><strong>Procesos en ejecución</strong></td>
								...
								<tr>
									<td style="width:30%;vertical-align:middle; padding:8px;"><strong>Promedio de carda de CPU</strong></td>
								...
								<tr>
									<td style="width:30%;vertical-align:middle; padding:8px;"><strong>Memoria real</strong></td>
									<td style="width:70%; vertical-align:middle; padding:8px;"><span data-id="sysinfo_real_memory"><?php echo $memory_total; ?> KiB total / <?php echo ($memory_used - $memory_buffers - $memory_cached); ?> KiB usado</span></td>
								</tr>

								<tr>
									<td style="width:30%;vertical-align:middle; padding:8px;"><strong>Espacio en disco local</strong></td>
									<td style="width:70%; vertical-align:middle; padding:8px;"><span data-id="sysinfo_disk_space"><?php echo $disk_total; ?> GB total / <?php echo $disk_free; ?> GB libre / <?php echo $disk_used; ?> GB usado</span></td>
								</tr>
				...
				<div id="top-processes" class="panel panel-default" style="margin-bottom: 5px">
					<div class="panel-heading">
						<h3 class="panel-title">Top Procesos</h3>
					</div>
					<div class="panel-body">
				...
				<div id="active-users" class="panel panel-default" style="margin-bottom: 5px">
					<div class="panel-heading">
						<h3 class="panel-title">Discos</h3>
					</div>
					<div class="panel-body">
